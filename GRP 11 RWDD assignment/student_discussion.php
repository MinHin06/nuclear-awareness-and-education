<?php
    ...
    $pageCss2 = "student_css/discussion.css";
...
<form method="get" class="search-bar">
    ...
    <a class="clear-btn" href="student_discussion.php">Clear</a>
</form>
...
<div class="list">
    <?php
        ...
        ?>
        <a class="topic-card" href="student_view_discussion.php?id=<?php echo $id; ?>">
